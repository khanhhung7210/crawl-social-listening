...
-- -----------------------------------------------------------------------------
-- 11) GIFT LEAD GEN (outbound sales leads — Admin only)
-- -----------------------------------------------------------------------------
...
-- NULLs allowed multiple times under Postgres UNIQUE; ON CONFLICT (mention_id) works.
...
COMMENT ON TABLE gift_leads IS 'Outbound gift-set sales leads from social demand signals (Admin / high role only).';
