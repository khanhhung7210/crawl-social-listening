...
Usage:
    ...
    python scripts/source_b/test_incremental_crawl.py threads

    # Test all platforms
    python scripts/source_b/test_incremental_crawl.py all

    # Dry run (show what would be tested)
    python scripts/source_b/test_incremental_crawl.py threads --dry-run
"""
...
PLATFORMS = {
    "threads": {
        "search_runner": "scripts/mkt/crawl/threads/threads_crawl_runner.py",
        "detail_runner": "scripts/mkt/crawl/threads/threads_replies_runner.py",
    ...
    "instagram": {
        "search_runner": "scripts/mkt/crawl/instagram/instagram_search_runner.py",
        "detail_runner": "scripts/mkt/crawl/instagram/instagram_post_runner.py",
        "expected_speedup": 4.0,
        "supports_early_stop": False,
    },
    "facebook": {
        "search_runner": "scripts/mkt/crawl/facebook/facebook_raw_runner.py",
    ...
    # Future platforms
    "tiktok": {
        "search_runner": "scripts/mkt/crawl/tiktok/tiktok_search_runner.py",
        "detail_runner": "scripts/mkt/crawl/tiktok/tiktok_video_runner.py",
        "expected_speedup": 5.0,
        "supports_early_stop": False,
        "implemented": True,
    },
    "youtube": {
        "search_runner": "scripts/mkt/crawl/youtube/youtube_search_runner.py",
        "detail_runner": "scripts/mkt/crawl/youtube/youtube_video_runner.py",
...
def main() -> int:
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python scripts/source_b/test_incremental_crawl.py <platform>")
        print("  python scripts/source_b/test_incremental_crawl.py all")
        print("\nAvailable platforms:")
