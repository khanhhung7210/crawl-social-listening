...
Usage:
  PYTHONPATH=src .venv/bin/python scripts/source_b/purge_non_vietnam_mentions.py
  PYTHONPATH=src .venv/bin/python scripts/source_b/purge_non_vietnam_mentions.py --dry-run
"""
