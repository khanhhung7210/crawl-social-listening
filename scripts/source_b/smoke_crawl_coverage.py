...
Usage (from social-listening root):
  ...
  python scripts/source_b/smoke_crawl_coverage.py [--platform facebook|tiktok|threads|instagram|all]
...
PLATFORMS = {
    "facebook": {
        "port": 9226,
        "script": "scripts/mkt/crawl/facebook/facebook_raw_runner.py",
    },
    "tiktok": {
        "port": 9223,
        "script": "scripts/mkt/crawl/tiktok/tiktok_search_runner.py",
    },
    "threads": {
        "port": 9222,
        "script": "scripts/mkt/crawl/threads/threads_crawl_runner.py",
    },
    "instagram": {
        "port": 9224,
        "script": "scripts/mkt/crawl/instagram/instagram_search_runner.py",
    },
}
