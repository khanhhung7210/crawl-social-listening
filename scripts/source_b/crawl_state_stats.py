...
Usage:
    python scripts/source_b/crawl_state_stats.py [platform]

Examples:
    python scripts/source_b/crawl_state_stats.py threads
    python scripts/source_b/crawl_state_stats.py          # Show all platforms
"""
...
def main() -> int:
    ...
    with IncrementalCrawlState() as state:
        if platform_arg:
            ...
            print("   python scripts/source_b/crawl_state_stats.py threads")
