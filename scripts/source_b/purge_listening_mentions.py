...
Usage:
  PYTHONPATH=src .venv/bin/python scripts/source_b/purge_listening_mentions.py
  PYTHONPATH=src .venv/bin/python scripts/source_b/purge_listening_mentions.py --dry-run
"""
