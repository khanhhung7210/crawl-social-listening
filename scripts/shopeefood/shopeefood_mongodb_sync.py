...
def main() -> int:
    config = MongoSyncConfig(
        input_file=Path(os.getenv("INPUT_FILE", str(platform_processed_dir("shopeefood") / "shopeefood_keyword_mentions.json"))),
        input_label="shopeefood_keyword_mentions.json",
