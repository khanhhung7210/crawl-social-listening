...
Usage:
  PYTHONPATH=src python3 scripts/mkt/classify/rebuild_mention_brands.py --dry-run
  PYTHONPATH=src python3 scripts/mkt/classify/rebuild_mention_brands.py --dry-run --limit 5000
  PYTHONPATH=src python3 scripts/mkt/classify/rebuild_mention_brands.py --dry-run --examples 5
