...
Examples:
  PYTHONPATH=src python3 scripts/mkt/run_continuous.py news --import-db --sleep 300
  PYTHONPATH=src python3 scripts/mkt/run_continuous.py facebook --import-db
  PYTHONPATH=src python3 scripts/mkt/run_continuous.py all --import-db --sleep 300
"""
