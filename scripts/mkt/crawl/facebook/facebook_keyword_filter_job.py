...
from social_listening.review_utils import VN_TZ, is_facebook_album_photo_url, parse_facebook_datetime_label
...
def build_grouped_post(
    ...
    # Album/carousel photo pages: keep for comment import, never as post buzz.
    skip_post_mention = bool(post.get("album_photo")) or is_facebook_album_photo_url(post_url)
    if skip_post_mention and not comment_items:
        return {}
    ...
    candidate = {
        ...
        "skip_post_mention": skip_post_mention,
        "source": SOURCE_NAME,
