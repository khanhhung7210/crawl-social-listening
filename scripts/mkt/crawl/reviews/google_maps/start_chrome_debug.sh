...
# Usage: ./scripts/mkt/crawl/reviews/google_maps/start_chrome_debug.sh
...
echo "   PYTHONPATH=src python3 scripts/mkt/crawl/reviews/google_maps/google_maps_review_runner.py"
echo ""
echo "🛑 To stop Chrome:"
