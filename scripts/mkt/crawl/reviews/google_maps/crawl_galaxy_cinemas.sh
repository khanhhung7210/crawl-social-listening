...
python3 scripts/mkt/crawl/reviews/google_maps/google_maps_search_runner.py

echo "== crawl reviews =="
python3 scripts/mkt/crawl/reviews/google_maps/google_maps_review_runner.py

echo "== format + filter + import =="
python3 scripts/mkt/crawl/reviews/google_maps/google_maps_format_job.py
python3 scripts/mkt/crawl/reviews/google_maps/google_maps_keyword_filter_job.py
python3 scripts/source_b/import_keyword_mentions.py --file data/google_maps/processed/galaxy_cinema/google_maps_keyword_mentions.json
