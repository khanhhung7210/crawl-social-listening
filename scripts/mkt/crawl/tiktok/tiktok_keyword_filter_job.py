...
INPUT_FILE = platform_processed_dir("tiktok") / "tiktok_grouped_parsed.json"
OUTPUT_FILE = platform_processed_dir("tiktok") / "tiktok_keyword_mentions.json"
SOURCE_NAME = "tiktok_keyword_filter_job"
...
def main() -> int:
    ...
    if not isinstance(payload, list):
        raise RuntimeError("tiktok_grouped_parsed.json must be a JSON array")
