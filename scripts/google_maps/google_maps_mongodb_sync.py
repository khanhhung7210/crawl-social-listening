...
def main() -> int:
    config = MongoSyncConfig(
        input_file=Path(os.getenv("INPUT_FILE", str(platform_processed_dir("google_maps") / "google_maps_keyword_mentions.json"))),
        input_label="google_maps_keyword_mentions.json",
